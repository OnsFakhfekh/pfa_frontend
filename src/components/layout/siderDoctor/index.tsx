...
export const SiderDoc: typeof DefaultSider = ({ render }) => {
  ...
  const dashboard = hasDashboard ? (
    <CanAccess resource="dashboard" action="list">
      <Tooltip
        title={translate("dashboard.title", "Acceuil")}
        placement="right"
        disableHoverListener={!collapsed}
        arrow
      >
        ...
        >
          ...
          <ListItemText
            primary={translate("dashboard.title", "Acceuil")}
            primaryTypographyProps={{
              noWrap: true,
              fontSize: "16px",
